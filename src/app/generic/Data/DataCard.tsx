export const data = [
    ...
    {
        title: 'data:image/jpeg;base64,',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'https://creditura.ru/wp-content/uploads/2020/06/logo-mfo-ekapusta.jpg',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'https://www.lime-zaim.ru/blog/wp-content/uploads/2019/10/logo.png',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'https://i.otzovik.com/objects/b/1800000/1795467.png',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'https://zaim-on-line.ru/ol/vivis-ru.jpg',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'https://dakakredit.com/wp-content/uploads/2021/06/file_5f3bd14c6a65e.png',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'data:image/png;base64,',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'https://zet-zaim.ru/zz/viva.jpg',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'https://snurk.ru/upload/iblock/ea1/zp69193xatkgz4cphmhjr2l5gqbbzeum.png',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'https://www.kreditos.ru/thumbs/200x200/ab78fde5a17d9d5b45c1b0c8b3efee0e.png',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
    ...
    {
        title: 'data:image/png;base64,',
        sum: 'От 100 руб',
        bet: '0%',
        loan: 'Первый займ 0%',
...
export const dataInsideCard = [
    ...
    },
    {
        ...
        inside: [
            ...
            {
                title: 'Подтверждение платёжеспособности',
                body: 'Не требуется',
            },
        ],
    },
    ...
    //     app: 'До 15 минут',
    //     prolongation: 'Есть',
    //     loanOne: 'Банковская карта, платёжные системы, qiwi кошелек, банковский счет',
    //     contract: 'Онлайн',
    //     repayment: 'В конце срока',
    //     age: '18+',
    //     nationality: 'Требуется',
    //     mob: 'Требуется',
    //     solvency: 'Не требуется',
    //     passpotr: 'Паспорт',
    //     profile: 'Заявление-анкета',
    // }
]
export const doc = [
    {
        title:
            ...
            'Куки-файлы - Cookies\n' +
            'Куки-файлы – это небольшие файлы, хранящиеся навашем устройстве (компьютере или мобильном устройстве).\n' +
            ...
            'Типы собираемых данных - Types of Data Collected\n' +
            'Персональные данные – Personal Data\n' +
            ...
            'Передачаданных - Transfer of Data\n' +
            ...
            'Безопасность данных - Security of Data\n' +
            ...
            'Поставщики услуг - ServiceProviders\n' +
            ...
            'Вы можете отказаться от определенных функций Firebase через настройки вашего мобильного устройства, такие как настройки рекламы на вашем устройстве или следуя инструкциям, предоставленным Google в их Политике конфиденциальности: https://policies.google.com/privacy?hl=ru. Мы также рекомендуем вам ознакомиться с политикой Google в отношении защиты ваших данных: https://support.google.com/analytics/answer/6004245.\n' +
            'Для получения дополнительной информации о том, какой тип информации собирает Firebase, посетите веб-страницу Условия конфиденциальности Google: https://policies.google.com/privacy?hl=ru.\n' +
            'Firebase is analytics service provided by Google Inc.\n' +
            'You may opt-out of certain Firebase features through your mobile device settings, such as your device advertising settings or by following the instructions provided by Google in their Privacy Policy: https://policies.google.com/privacy?hl=en\n' +
            'We also encourage you to review the Google\'s policy for safeguarding your data: https://support.google.com/analytics/answer/6004245\n' +
            'For more information on what type of information Firebase collects, please visit the Google Privacy Terms web page: https://policies.google.com/privacy?hl=en\n' +
            'Ссылки на другие сайты - Links to Other Sites\n' +
            ...
            'Конфиденциальность детей - Children\'sPrivacy\n' +
            ...
            'Loan term: 90-365 days allowed\n' +
            'Depending on the loan term and the user\'s credit history, the interest rate is 0.1-1% per day, the annual interest rate is 36-360%.\n' +
            'Example of calculation: for a loan of 50,000₽ for 14 weeks (98 days) at the rate of 0.8% per day, the amount of payment once every 2 weeks will be 10,679. 42₽, the total amount of payments-74,755. 94₽\n' +
            ...
            'This application does not issue loans or loans and is not a financial institution, Bank or lender, but only aggregates banks and MFIs that issue money at interest in cash, card or other ways and does not require a license to conduct such activities.\n' +
